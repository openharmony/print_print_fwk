...
static napi_value Init(napi_env env, napi_value exports)
{
    napi_property_descriptor desc[] = {
        DECLARE_NAPI_PROPERTY("PrintDirectionMode", NapiCreateDirectionModeEnum(env)),
        DECLARE_NAPI_PROPERTY("PrintColorMode", NapiCreateColorModeEnum(env)),
        DECLARE_NAPI_PROPERTY("PrintDuplexMode", NapiCreateDuplexModeEnum(env)),
        DECLARE_NAPI_PROPERTY("PrintQuality", NapiCreateQualityEnum(env)),
        DECLARE_NAPI_PROPERTY("PrintDocumentFormat", NapiCreateDocumentFormatEnum(env)),
        DECLARE_NAPI_PROPERTY("DocFlavor", NapiCreateDocFlavorEnum(env)),
        DECLARE_NAPI_PROPERTY("PrintOrientationMode", NapiCreateOrientationEnum(env)),
        DECLARE_NAPI_PROPERTY("PrintPageType", NapiCreatePageTypeEnum(env)),
        DECLARE_NAPI_PROPERTY("PrintDocumentAdapterState", NapiCreateDocumentAdapterStateEnum(env)),
        DECLARE_NAPI_PROPERTY("PrintFileCreationState", NapiCreateFileCreationStateEnum(env)),
        DECLARE_NAPI_PROPERTY("PrinterState", NapiCreatePrinterStateEnum(env)),
        DECLARE_NAPI_PROPERTY("PrintJobState", NapiCreatePrintJobStateEnum(env)),
        DECLARE_NAPI_PROPERTY("PrintJobSubState", NapiCreatePrintJobSubStateEnum(env)),
        DECLARE_NAPI_PROPERTY("PrintErrorCode", NapiCreatePrintErrorCodeEnum(env)),
        DECLARE_NAPI_PROPERTY("PrinterStatus", NapiCreatePrintStatusEnum(env)),
        DECLARE_NAPI_PROPERTY("PrinterEvent", NapiCreatePrintEventEnum(env)),
        DECLARE_NAPI_PROPERTY("ApplicationEvent", NapiCreateApplicationEventEnum(env)),
        DECLARE_NAPI_PROPERTY("DefaultPrinterType", NapiCreateDefaultPrinterTypeEnum(env)),
        DECLARE_NAPI_PROPERTY("WatermarkHandleResult", NapiCreateWatermarkHandleResultEnum(env)),
