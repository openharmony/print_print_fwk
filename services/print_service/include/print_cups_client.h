...
private:
    ...
    static int UpdatePrintJobStateInJobParams(JobParameters *jobParams, uint32_t state, uint32_t substate);
    static int UpdateJobStatus(JobStatus *prevousJobStatus, JobStatus *jobStatus);
