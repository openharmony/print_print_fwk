...
CreateJsPrintExtensionContext(NativeEngine &engine,
...
#else
  BindNativeFunction(engine, *object, "startAbility",
                     JsPrintExtensionContext::StartAbility);
  BindNativeFunction(engine, *object, "terminateSelf",
                     JsPrintExtensionContext::TerminateAbility);
  BindNativeFunction(engine, *object, "connectAbility",
  ...
  BindNativeFunction(engine, *object, "connectAbilityWithAccount",
