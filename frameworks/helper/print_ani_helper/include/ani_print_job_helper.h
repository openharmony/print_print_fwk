 ...
 */
#ifndef OHOS_ANI_PRINT_JOB_HELPER_H
#define OHOS_ANI_PRINT_JOB_HELPER_H
...
class AniPrintJobHelper {
public:
    static PrintJob ParsePrintJob(ani_env *env, ani_object jobInfoAni);
    static ani_object CreatePrintJob(ani_env *env, const PrintJob& printJob);
...
#endif  // OHOS_ANI_PRINT_JOB_HELPER_H