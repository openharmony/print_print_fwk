...
namespace OHOS::Print {
    enum IPrintInterfaceCode {
        ...
        CMD_SAVEPDFFILEJOB,
        CMD_QUERYRECOMMENDDRVIERSBYID,
        CMD_CONNECTPRINTERBYIDANDPPD,
        CMD_CHECKPREFERENCESCONFLICTS,
        CMD_CHECKPRINTJOBCONFLICTS,
        CMD_GETPRINTERDEFAULTPREFERENCES,
        CMD_GET_SHAREDHOSTS,
        CMD_START_SHARED_HOST_DISCOVERY,
        CMD_AUTH_SMB_DEVICE,
        CMD_REG_WATERMARK_CB,
