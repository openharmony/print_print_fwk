...
int32_t PrintManagerClient::On(const std::string &taskId,
...
int32_t PrintManagerClient::Off(const std::string &taskId,
                                const std::string &type) {
...
int32_t PrintManagerClient::LoadExtSuccess(const std::string &extensionId) {
  ...
  PRINT_HILOGD("PrintManagerClient LoadExtSuccess out ret = [%{public}d].",
               ret);
  return ret;
}
