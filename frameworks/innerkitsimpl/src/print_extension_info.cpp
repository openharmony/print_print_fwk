...
PrintExtensionInfo::PrintExtensionInfo()
    : extensionId_(0), vendorId_(0), vendorName_("PrintExtensionInfo"),
...
uint32_t PrintExtensionInfo::GetExtensionId() const { return extensionId_; }

uint32_t PrintExtensionInfo::GetVendorId() const { return vendorId_; }
