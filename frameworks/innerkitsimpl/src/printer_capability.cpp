...
void PrinterCapability::BuildFromParcel(MessageParcel &data) {
  ...
  PRINT_HILOGD("PrintServiceProxy, arraypageSizeLength = %{public}d",
               arraypageSizeLength);
  PRINT_HILOGD("PrintServiceProxy, resolutionLength = %{public}d",
               resolutionLength);
...
void PrinterCapability::ConvertToJs(napi_env env, napi_value *result) const {
  ...
  NapiPrintUtils::SetUint32Property(env, *result, "duplexMode",
                                    GetDuplexMode());

  PrintMargin margin;
  GetMinMargin(margin);
  NapiPrintUtils::SetUint32Property(env, resultPrintMargin, "top",
                                    margin.GetTop());
  NapiPrintUtils::SetUint32Property(env, resultPrintMargin, "bottom",
                                    margin.GetBottom());
  NapiPrintUtils::SetUint32Property(env, resultPrintMargin, "left",
                                    margin.GetLeft());
  NapiPrintUtils::SetUint32Property(env, resultPrintMargin, "right",
                                    margin.GetRight());
  ...
  for (uint32_t i = 0; i < printerCapabilityLength; i++) {
    ...
    NapiPrintUtils::SetStringPropertyUtf8(env, resultPrinterPageSize, "id",
                                          pageSize[i].GetId().c_str());
    NapiPrintUtils::SetStringPropertyUtf8(env, resultPrinterPageSize, "name",
                                          pageSize[i].GetName().c_str());
    NapiPrintUtils::SetUint32Property(env, resultPrinterPageSize, "width",
                                      pageSize[i].GetWidth());
    NapiPrintUtils::SetUint32Property(env, resultPrinterPageSize, "height",
                                      pageSize[i].GetHeight());
  ...
  for (uint32_t i = 0; i < printerCapabilityresolutionLength; i++) {
    ...
    NapiPrintUtils::SetUint32Property(env, resultPrinterResolution, "id",
                                      resolutionList[i].GetId());
    NapiPrintUtils::SetUint32Property(env, resultPrinterResolution,
                                      "horizontalDpi",
                                      resolutionList[i].GetHorizontalDpi());
    NapiPrintUtils::SetUint32Property(env, resultPrinterResolution,
                                      "verticalDpi",
                                      resolutionList[i].GetVerticalDpi());
    status = napi_set_element(env, arrResolution, i, resultPrinterResolution);
  }

  status =
      napi_set_named_property(env, *result, "minMargin", resultPrintMargin);
...
bool PrinterCapability::ParseCapability(napi_env env, napi_value capValue) {
  ...
  SetColorMode(NapiPrintUtils::GetUint32Property(env, capValue,
                                                 PARAM_CAPABILITY_COLORMODE));
  SetDuplexMode(NapiPrintUtils::GetUint32Property(env, capValue,
                                                  PARAM_CAPABILITY_DUPLEXMODE));
...
bool PrinterCapability::ParseCapabilityParam(napi_env env,
                                             napi_value capValue) {
...
bool PrinterCapability::ParseMargin(napi_env env, napi_value marginValue,
                                    PrintMargin &margin) {
...
bool PrinterCapability::ParseMarginParam(napi_env env, napi_value marginValue,
                                         PrintMargin &margin) {
...
bool PrinterCapability::ParsePageSize(napi_env env, napi_value capValue,
                                      PrintPageSize &pageSize) {
...
bool PrinterCapability::ParsePageSizeParam(napi_env env, napi_value capValue,
                                           PrintPageSize &pageSize) {
  napi_value param_one =
...
bool PrinterCapability::ParseResolution(napi_env env, napi_value reValue,
                                        PrintResolution &resolution) {
...
bool PrinterCapability::ParseResolutionParam(napi_env env, napi_value reValue,
                                             PrintResolution &resolution) {
  napi_value param_one =
