...
PrinterInfo::PrinterInfo()
    : printerId_(0), printerName_(""), printerIcon_(0),
      printerState_(PRINTER_UNKNOWN), description_("") {}
...
void PrinterInfo::SetPrinterId(uint32_t printerId) { printerId_ = printerId; }
...
uint32_t PrinterInfo::GetPrintId() const { return printerId_; }
