...
public:
  ...
  static bool HasNamedProperty(napi_env env, napi_value object,
                               const std::string &propertyName);
  static napi_value GetNamedProperty(napi_env env, napi_value object,
                                     const std::string &propertyName);
  static void SetNamedProperty(napi_env env, napi_value object,
                               const std::string &name, napi_value value);
  static std::vector<std::string> GetPropertyNames(napi_env env,
                                                   napi_value object);
  ...
  static uint32_t GetUint32Property(napi_env env, napi_value object,
                                    const std::string &propertyName);
  static void SetUint32Property(napi_env env, napi_value object,
  ...
  static int32_t GetInt32Property(napi_env env, napi_value object,
                                  const std::string &propertyName);
  static void SetInt32Property(napi_env env, napi_value object,
  ...
  static std::string GetStringPropertyUtf8(napi_env env, napi_value object,
                                           const std::string &propertyName);
  static void SetStringPropertyUtf8(napi_env env, napi_value object,
  ...
  static void *GetInfoFromArrayBufferValue(napi_env env, napi_value value,
                                           size_t *length);
  ...
  static napi_value CreateFunction(napi_env env, const std::string &name,
                                   napi_callback func, void *arg);
  ...
  static bool GetBooleanProperty(napi_env env, napi_value object,
                                 const std::string &propertyName);
  static void SetBooleanProperty(napi_env env, napi_value object,
  ...
  static std::string GetGlobalId(const std::string &extensionId,
                                 const std::string &localId);
  static std::string GetLocalId(const std::string &globalId,
                                const std::string &extensionId);
  static std::string EncodeExtensionCid(const std::string &extensionId,
                                        uint32_t callbackId);
  static bool DecodeExtensionCid(const std::string &cid,
                                 std::string &extensionId,
                                 uint32_t &callbackId);
  static std::string GetTaskEventId(const std::string &taskId,
