 ...
 */
#ifndef MOCK_SCAN_REMOTE_OBJECT_H
#define MOCK_SCAN_REMOTE_OBJECT_H
...
namespace OHOS::Scan {
class MockScanRemoteObject final : public IRemoteObject {
public:
    MockScanRemoteObject() : IRemoteObject(u"")
    {}
...
#endif  // MOCK_SCAN_REMOTE_OBJECT_H
