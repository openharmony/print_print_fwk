...
#ifndef PRINT_UNITTEST_MOCK_UICONTENT_H
#define PRINT_UNITTEST_MOCK_UICONTENT_H
...
public:
    MOCK_METHOD3(
        Initialize, UIContentErrorCode(OHOS::Rosen::Window *window, const std::string &url, napi_value storage));
    ...
    MOCK_METHOD3(
        InitializeByName, UIContentErrorCode(OHOS::Rosen::Window *window, const std::string &name, napi_value storage));
    ...
    MOCK_METHOD3(CreateModalUIExtension, int32_t(const AAFwk::Want &want, const ModalUIExtensionCallbacks &callbacks,
    ...
    MOCK_METHOD0(GetContainerModalTitleHeight, int32_t());
};
}  // namespace Ace
}  // namespace OHOS
#endif  // PRINT_UNITTEST_MOCK_UICONTENT_H