...
HWTEST_F(ScanCallbackStubTest, OnRemoteRequest_WrongDescriptor, TestSize.Level1)
{
  ...
  EXPECT_EQ(callback->OnRemoteRequest(code, data, reply, option),
            E_SCAN_RPC_FAILURE);
}
...
HWTEST_F(ScanCallbackStubTest, OnRemoteRequest_DeviceInfoEvent_Success,
         TestSize.Level1)
{
  MessageParcel data;
  MessageParcel reply;
...
HWTEST_F(ScanCallbackStubTest, HandleDeviceInfoEvent_UnmarshallingNull,
         TestSize.Level1)
{
  MessageParcel data;
  MessageParcel reply;
...
HWTEST_F(ScanCallbackStubTest, OnRemoteRequest_DeviceInfoSyncEvent_Success,
         TestSize.Level1)
{
  MessageParcel data;
  MessageParcel reply;
  ...
  auto callback = std::make_shared<MockScanCallbackStub>();
  EXPECT_NE(callback, nullptr);
  EXPECT_CALL(*callback, OnCallbackSync(state, _))
      .Times(1)
...
HWTEST_F(ScanCallbackStubTest, HandleDeviceInfoSyncEvent_UnmarshallingNull,
         TestSize.Level1)
{
  MessageParcel data;
  MessageParcel reply;
...
HWTEST_F(ScanCallbackStubTest, OnRemoteRequest_DeviceListEvent_Success,
         TestSize.Level1)
{
  MessageParcel data;
  MessageParcel reply;
...
HWTEST_F(ScanCallbackStubTest, HandleSendDeviceList_ExceedRange,
         TestSize.Level1)
{
  MessageParcel data;
  MessageParcel reply;
...
HWTEST_F(ScanCallbackStubTest, HandleSendDeviceList_UnmarshallingNull,
         TestSize.Level1)
{
  MessageParcel data;
  MessageParcel reply;
