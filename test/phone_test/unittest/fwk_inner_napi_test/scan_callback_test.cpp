...
HWTEST_F(ScanCallbackTest, ScanCallbackTest_OnGetDevicesList_001,
         TestSize.Level1)
{
  std::vector<ScanDeviceInfo> infos;
  std::function<void(std::vector<ScanDeviceInfo> & infos)> callbackFunction =
...
HWTEST_F(ScanCallbackTest, ScanCallbackTest_OnGetDevicesList_002,
         TestSize.Level1)
{
  std::vector<ScanDeviceInfo> infos;
  auto callback = std::make_shared<ScanCallback>(nullptr, nullptr);
...
HWTEST_F(ScanCallbackTest, ScanCallbackTest_NapiCallFunction_001,
         TestSize.Level1)
{
  auto callback = std::make_shared<ScanCallback>(nullptr, nullptr);
  EXPECT_NE(callback, nullptr);
...
HWTEST_F(ScanCallbackTest, ScanCallbackTest_NapiCallFunction_002,
         TestSize.Level1)
{
  auto callback = std::make_shared<ScanCallback>(nullptr, nullptr);
  EXPECT_NE(callback, nullptr);
...
HWTEST_F(ScanCallbackTest, ScanCallbackTest_ExecuteNapiEventWork_001,
         TestSize.Level1)
{
  auto callback = std::make_shared<ScanCallback>(nullptr, nullptr);
  EXPECT_NE(callback, nullptr);
...
HWTEST_F(ScanCallbackTest, ScanCallbackTest_ExecuteNapiEventWork_002,
         TestSize.Level1)
{
  auto callback = std::make_shared<ScanCallback>(nullptr, nullptr);
  EXPECT_NE(callback, nullptr);
...
HWTEST_F(ScanCallbackTest, ScanCallbackTest_NapiCallFunction_003,
         TestSize.Level1)
{
